package com.matt.libimport.widget.statusbar;
...
public class StatusBarUtil {
    ...
    private static final int FAKE_STATUS_BAR_VIEW_ID = R.id.import_statusbarutil_fake_status_bar_view;
    private static final int FAKE_TRANSLUCENT_VIEW_ID = R.id.import_statusbarutil_translucent_view;
    ...
    public static void setLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // FIXME: 2019-06-24 这个会导致状态栏上移
            //activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
    }
    @TargetApi(Build.VERSION_CODES.M)
    public static void setLightModeV2(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, true);
        setMeizuStatusBarDarkIcon(activity, true);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
    ...
    @TargetApi(Build.VERSION_CODES.M)
    public static void setDarkModeV2(Activity activity) {
        setMIUIStatusBarDarkIcon(activity, false);
        setMeizuStatusBarDarkIcon(activity, false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN);
